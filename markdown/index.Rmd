...
packages <- c("openxlsx", "tinytex", "bookdown", "gtsummary", "xtable", "stargazer", "data.table", "gridExtra", "fmsb", "grid", "ggrepel", "ggcorrplot", "tidyverse", "lamadex", "kableExtra")
...
\begin{singlespace}
```{r, tbl-macrocorr, results = "asis", fig.pos='H'}
```
\end{singlespace}
...
```{r, fig-youthpop, fig.align = "center", out.width = '49%', fig.pos='H', fig.show='hold', fig.scap = "World youth population, 1960-2020", fig.cap="World youth population, 1960-2020 \\\\ \\textit{\\footnotesize{Source: World Population Prospects, United Nations (2019)}}"}
...
```{r, fig-indexgdp, fig.align = "center", fig.height=3.5, fig.pos='H', fig.cap="Correlation, YLILI score and GDP per capita"}
```

```{r, fig-indexunemp, fig.align = "center", fig.height=3.5, fig.pos='H', fig.cap="Correlation, YLILI score and national youth unemployment rate"}
```
...
```{r fig-stacked, fig.align = "center", out.width = '43%', fig.show='hold', fig.pos='H', fig.scap = "Share of world population by age group, 1960-2020", fig.cap="Share of world population by age group, 1960-2020 \\\\ \\textit{\\footnotesize{Source: World Population Prospects, United Nations (2019)}}"}
...
```{r fig-pyramids, fig.align = "center", out.width = '43%', fig.show='hold', fig.pos='H', fig.scap = "Population pyramids for sub-Saharan Africa", fig.cap="Population pyramids for sub-Saharan Africa (left) vs. the world (right) \\\\ \\textit{\\footnotesize{Source: World Population Prospects, United Nations (2019)}}"}
...
```{r, fig-transitionmap, fig.align = "center", out.width = '70%', fig.show='hold', fig.pos='H', fig.cap="Indicators of the transition dimension depicted by country"}
...
```{r, fig-workcondmap, fig.align = "center", out.width = '52%', fig.show='hold', fig.pos='H', fig.cap="Indicators of the working conditions dimension depicted by country"}
...
```{r, fig-educationmap, fig.align = "center", out.width = '69%', fig.show='hold', fig.pos='H', fig.cap="Indicators of the education dimension depicted by country"}
...
```{r, fig-worldmap, fig.align = "center", out.width = '100%', fig.pos='H', fig.cap = "Total YLILI depicted by country"}
knitr::include_graphics("figures/maps/YLILI_total.png")
```

```{r, fig-totalmap, fig.align = "center", out.width = '69%', fig.pos='H', fig.show='hold', fig.cap="Dimensions of the YLILI depicted by country"}
...
```{r, fig-spider, out.width = '49%', fig.show='hold', fig.pos='H', fig.cap="Spider charts by world region"}
```
...
```{r tbl-gender, results = "asis", fig.pos='H',}
```
...
```{r, fig-arithgeom, fig.align = "center", fig.height=3.5, fig.pos='H', fig.cap="Comparison of aggregation methods"}
```

```{r, fig-imputedraw, fig.align = "center", fig.height=3.5, fig.pos='H', fig.cap="YLILI with and without imputation"}
```
