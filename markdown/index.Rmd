...
\todo{4}
```{r, fig-infneet, fig.cap="Relationship between youth NEET rate and informality by income level", fig.height=4, fig.width=8, fig.pos='H'}
```
