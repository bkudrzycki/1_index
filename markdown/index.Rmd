...
packages <- c("openxlsx", "tinytex", "bookdown", "gtsummary", "xtable", "stargazer", "kableExtra", "data.table", "gridExtra", "fmsb", "grid", "ggrepel", "ggcorrplot", "tidyverse", "lamadex")
...
```{r, fig-youthpop, fig.align = "center", out.width = '49%', fig.show='hold', fig.cap="World youth population, 1960-2020 \\\\ \\textit{\\footnotesize{Source: World Population Prospects, United Nations (2019)}}"}
...
```{r fig-stacked, fig.align = "center", out.width = '49%', fig.show='hold', fig.cap="Share of world population by age group, 1960-2020 \\\\ \\textit{\\footnotesize{Source: World Population Prospects, United Nations (2019)}}"}
...
```{r fig-pyramids, fig.align = "center", out.width = '49%', fig.show='hold', fig.cap="Population pyramids for sub-Saharan Africa (left) vs. the world (right) \\\\ \\textit{\\footnotesize{Source: World Population Prospects, United Nations (2019)}}"}
...
```{r, fig-transitionmap, echo=FALSE, fig.align = "center", out.width = '70%', fig.show='hold', fig.cap="Indicators of the transition dimension depicted by country"}
...
```{r, fig-workcondmap, echo=FALSE, fig.align = "center", out.width = '52%', fig.show='hold', fig.cap="Indicators of the working conditions dimension depicted by country"}
...
```{r, fig-educationmap, echo=FALSE, fig.align = "center", out.width = '69%', fig.show='hold', fig.cap="Indicators of the education dimension depicted by country"}
...
```{r, fig-worldmap, echo=FALSE, fig.align = "center", out.width = '100%', fig.cap = "Total YLILI depicted by country"}
knitr::include_graphics("figures/maps/YLILI_total.png")
```

```{r, fig-totalmap, echo=FALSE, fig.align = "center", out.width = '69%', fig.show='hold', fig.cap="Dimensions of the YLILI depicted by country"}
...
```{r, fig-spider, echo=FALSE, out.width = '49%', fig.show='hold', fig.cap="Spider charts by world region"}
```
